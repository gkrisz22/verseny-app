...
import TodoSection from './_components/dashboard/todo-section'
import RecentActivitiesSection from './_components/dashboard/recent-activities-section'
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-2">Szervezeti tevékenységek</p>
      </div>
        <StatisticsSection />
        <div className='grid md:grid-cols-2 gap-4'>
          <div className="flex flex-col space-y-4">
            <h2 className="text-2xl font-bold tracking-tight">Teendők</h2>
            <TodoSection />
          </div>
          <div className="flex flex-col space-y-4">
            <h2 className="text-2xl font-bold tracking-tight">Tevékenységi napló</h2>
