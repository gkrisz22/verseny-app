...
const TopNav = ({ user }: { user: User | undefined }) => {
  ...
  return (
    <header className="bg-background border-b flex h-16 shrink-0 items-center gap-2 transition-[width,height] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12">
